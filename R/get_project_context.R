...
get_project_context <- function() {
  list(
    ...
    rstudio_active_project = ipc_call("getActiveProject"), # The path to the currently active RStudio project.
    # The path of the file currently open in the RStudio source editor.
    rstudio_source_editor_context = ipc_call("getSourceEditorContext")$path,
